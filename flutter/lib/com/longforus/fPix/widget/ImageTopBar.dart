        ...
        () => tc.topData.isEmpty
            ...
            : GestureDetector(
                child: CachedNetworkImage(
                  imageUrl: tc.topData["type"] == "animation"
                      ? getVideoImageUrl(tc.topData)
                      : tc.topData['webformatURL'],
                  cacheKey: tc.topData["type"] == "animation"
                      ? getVideoImageUrl(tc.topData)
                      : getCacheKey(tc.topData, 'webformatURL'),
                  fit: BoxFit.cover,
                ),
                onTap: _go2PhotoPage,
              ),
